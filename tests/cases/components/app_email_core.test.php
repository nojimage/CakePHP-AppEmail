<?php
/**
 * AppEmailComponentTest file
 *
 * based on CakePHP 1.3.13
 *
 ...
 */
class EmailTestComponent extends AppEmailComponent {
 ...
 * @subpackage    cake.tests.cases.libs.controller.components
 */
class AppEmailCoreComponentTest extends CakeTestCase {
 ...
 */
	function testSendWithAttachments() {
		...
		$this->assertPattern('/' . preg_quote('Content-Disposition: attachment; filename="app_email_core.test.php"') . '/', $msg);
